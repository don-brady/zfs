...
extern void fmd_serd_init(void);
extern void fmd_serd_fini(void);

extern void fmd_serd_create(const char *, uint_t, hrtime_t);
extern void fmd_serd_destroy(const char *);
extern int fmd_serd_exists(const char *);
extern void fmd_serd_reset(const char *);
extern int fmd_serd_record(const char *, uint64_t, const struct timespec *);
extern int fmd_serd_fired(const char *);
extern int fmd_serd_empty(const char *);
